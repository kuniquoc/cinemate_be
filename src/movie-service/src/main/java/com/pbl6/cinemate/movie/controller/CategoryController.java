...
public class CategoryController {
    ...
    public ResponseEntity<ResponseData> addMovieToCategory(@PathVariable UUID categoryId, @PathVariable UUID movieId,
    ...
    public ResponseEntity<ResponseData> removeMovieFromCategory(@PathVariable UUID categoryId, @PathVariable UUID movieId,
                                                                HttpServletRequest request) {
    ...
    public ResponseEntity<ResponseData> getMoviesByCategory(@PathVariable UUID categoryId, HttpServletRequest request) {
