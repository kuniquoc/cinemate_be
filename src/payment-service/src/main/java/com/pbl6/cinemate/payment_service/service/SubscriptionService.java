...
public class SubscriptionService {
     ...
     * This is the recommended method as it ensures amount and email are server-side
     * controlled
     */
    @Transactional
    ...
    private SubscriptionResponse mapToResponse(Subscription subscription) {
        ...
        response.setPlan(modelMapper.map(subscription.getPlan(),
                com.pbl6.cinemate.payment_service.dto.response.SubscriptionPlanResponse.class));
        return response;
    }
