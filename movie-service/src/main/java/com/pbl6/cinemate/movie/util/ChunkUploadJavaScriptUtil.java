...
/**
 * JavaScript utility for chunk upload implementation on the client side.
 * This class provides the JavaScript code that can be used in frontend
 * applications
 * to implement chunked file uploads.
 */
public class ChunkUploadJavaScriptUtil {

    private ChunkUploadJavaScriptUtil() {
        // Utility class
    }

    public static final String CHUNK_UPLOAD_JS = """
            class ChunkUploader {
            ...
            uploader.onError = (message, error) => {
