...
public class ChunkUploadController {
    ...
    public ResponseEntity<ResponseData> uploadChunk(
        ...
        ChunkUploadResponse response = chunkUploadService.uploadChunk(uploadId, chunkNumber, chunkFile, request);
    ...
    @Operation(summary = "Get JavaScript client", description = "Get the JavaScript client code for chunk upload implementation")
    @GetMapping("/client.js")
    public ResponseEntity<String> getJavaScriptClient() {
        return ResponseEntity.ok()
                .header("Content-Type", "application/javascript")
                .body(com.pbl6.cinemate.movie.util.ChunkUploadJavaScriptUtil.CHUNK_UPLOAD_JS);
    }
}